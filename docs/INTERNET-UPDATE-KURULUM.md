...
Web'den `Sakuratech/SakuraPos` repo'sunu **public** olarak aç (henüz açmadıysan). Açıklama: "Sakura POS — restoran yönetim sistemi". `.gitignore`, README, license **eklemeden** boş bırak (yerel zaten var).
